...
//Funciones para el mock
  ...
  //Implementació del codi de la vista per l'usuari
    public static void main (String[] args)
    {
      ...
      //Comprobem que s'ha introduït un valor correcte
      ...
      switch(entradaTecladoOp) {
        ...
        default:
          operacion = "Error: No ha introducido un valor correcto";
      ...
      if(c1 || c2) {
        ...
        if (c3 || c4) {
          //Comprobació per saber si l'operació seleccionada requereix d'un valor o de dos
      ...
      }//Segons si l'operació es d'un o de dos valors, es fa el print corresponent
      if((entradaTecladoOp > 0) && (entradaTecladoOp <= 5)) {
